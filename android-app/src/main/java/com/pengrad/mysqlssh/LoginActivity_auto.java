 ...
 * well.
 */
public class LoginActivity_auto extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewUser = (EditText) findViewById(R.id.user);
    ...
    public void attemptLogin() {
        ...
        if (TextUtils.isEmpty(mEmail)) {
            mViewUser.setError(getString(R.string.error_field_required));
            focusView = mViewUser;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            mLoginStatusMessageView.setText(R.string.login_progress_connecting);
            showProgress(true);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mViewPassword.setError("Password");
